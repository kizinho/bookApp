...
import 'package:booksfinder/view/home/book/tabs/skeleton_data_tab.dart';
import 'package:booksfinder/view/home/book/tabs/tab_data_books.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(() => Column(
          children: [
            ...
            if (search.checkResult.value == true)
              Center(
                child: Text(
                  'No Result found for ${books.searchTitle.value}',
                  style: Theme.of(context).textTheme.subtitle2,
                ),
              )
            else if (search.itemData!.isEmpty)
            ...
            if (search.itemData!.length >= books.searchMaxResult.value)
              Loader(),
          ],
        ));
  }
